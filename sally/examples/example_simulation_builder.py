...
from sally.simulation.mosaik_simulators.pv import PV_SIM_ID, PVSim
from sally.simulation.mosaik_simulators.line import LINE_SIM_ID, LineSim
from sally.simulation.mosaik_simulators.node import NODE_SIM_ID, NodeSim
from sally.simulation.mosaik_simulators.generator import GEN_SIM_ID, GeneratorSim
from sally.simulation.mosaik_simulators.load import LOAD_SIM_ID, LoadSim
from sally.simulation.mosaik_simulators.battery import BATTERY_SIM_ID, BatterySim
from sally.simulation.mosaik_simulators.protection_relay import RELAY_SIM_ID, ProtectionRelaySim
from sally.simulation.mosaik_simulators.monitor import MONITOR_SIM_ID, MonitorSim
from sally.simulation.simulation_builder import SimulationBuilder
from sally.simulation.data_provider import RandomDataProvider, SinusoidalDataProvider
...
# =============================================================================
# SimulationBuilder Examples - Demonstrating Various Simulation Scenarios
# =============================================================================
#
# This file demonstrates 7 different ways to use SimulationBuilder:
# 1. Basic HDF5 simulation with default services
# 2. Custom TimescaleDB connection
# 3. Custom rule manager configuration
# 4. Full integration with EventBus and all services
# 5. Random data provider (no HDF5 file needed)
# 6. Sinusoidal data provider for periodic patterns
# 7. Mosaik co-simulation integration
#
# All examples now use ContainerType.SIMULATION which provides the standard
# simulation container with SmartGridDatabase and DummySmartGridRuleManager.
# =============================================================================
